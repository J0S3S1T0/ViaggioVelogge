...
function AnimatedSpeedometer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gray-900 rounded-full w-48 h-48 mx-auto shadow-lg">
      <div className="text-4xl font-bold text-blue-400">{speed}</div>
      <p className="text-sm text-gray-400 mb-2">km/h</p>
      <button
        onClick={togglePlay}
    ...
    <div className="bg-black text-white min-h-screen px-8 pt-24 pb-8">
      ...
      <section className="text-center mb-12">
        <div className="flex justify-center items-center gap-4 mb-4">
          <Image src="/Ferrari250.png" alt="Gear icon" width={32} height={32} />
          <h1 className="text-4xl font-bold">FERRARI 250 GTO 1962</h1>
          <Image src="/gearIcon.png" alt="Gear icon" width={32} height={32} />
        </div>
        <Image
          src="/Ferrari250.png"
          alt="Ferrari 250 GTO"
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center text-center">
        <div>
          <Image src="/Ferrari250VistaFrotal.png" alt="Ferrari side view" width={400} height={250} className="rounded-lg mx-auto" />
        </div>
        <div>
...
<section className="mt-16 text-center">
  ...
  <div className="mb-8">
    <Image
      src="/Ferrari250VistaArriba.png" // Asegúrate de tener esta imagen en /public
    ...
    <div>
      ...
      <section className="mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gray-900 p-6 rounded-lg shadow-lg text-sm text-gray-300">
