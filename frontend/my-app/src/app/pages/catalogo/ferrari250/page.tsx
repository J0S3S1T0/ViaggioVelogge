      ...
      <div className="px-8 pt-32 pb-8">
        ...
        <section className="mt-20 bg-gradient-to-r from-gray-800 to-gray-900 py-12 px-6 rounded-lg text-center border border-gray-700">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Nuestros asesores especializados están disponibles para responder todas tus preguntas sobre esta legendaria Ferrari y otros modelos.
          </p>
          <div className="flex flex-col md:flex-row justify-center gap-6">
            <a
              href="/pages/contacto"
              className="bg-red-600 hover:bg-red-700 text-white font-semibold px-8 py-3 rounded-full transition flex items-center justify-center gap-2"
            >
